...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // 3.5 days //updated to 1 day
        ...
        //vSeeds.emplace_back("seed-a.mcoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.mcointools.com");
        //vSeeds.emplace_back("dnsseed.mcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        //vSeeds.emplace_back("testnet-seed.mcointools.com");
        //vSeeds.emplace_back("seed-b.mcoin.loshan.co.uk");
