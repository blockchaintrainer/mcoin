...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " mcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  mcoin-tx [options] <hex-tx> [commands]  Update hex-encoded mcoin transaction\n" +
            "or:     mcoin-tx [options] -create [commands]   Create hex-encoded mcoin transaction\n" +
            "\n";
