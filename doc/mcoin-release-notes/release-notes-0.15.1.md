Mcoin Core version *0.15.1* is now available from:

  <https://download.mcoin.org/mcoin-0.15.1/>
...
A number of changes to the way Mcoin Core deals with peer connections and invalid blocks
