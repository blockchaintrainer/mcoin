...
* mcoin.conf: contains configuration settings for mcoind or mcoin-qt
* mcoind.pid: stores the process id of mcoind while running
...
* debug.log: contains debug information and general logging generated by mcoind or mcoin-qt
