# Support for Output Descriptors in Mcoin Core

Since Mcoin Core v0.17, there is support for Output Descriptors in the
...
on Mcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Mcoin Core wallets, a convenience function `combo` is
