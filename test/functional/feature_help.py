...
"""Verify that starting mcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mcoin with -h for help text")
        ...
        self.log.info("Start mcoin with -version for version information")
        ...
        self.log.info("Start mcoind with -fakearg to make sure it does not start")
